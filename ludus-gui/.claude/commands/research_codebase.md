...
2. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   - Thoughts directory sub-agent prompt:
     ```
     Explore the __agents__/research/ directory for context related to [topic]:
     1. Search for any relevant information in __agents__/research/ and its subdirectories
     ...
     (Path sanitization rules for the legacy 'thoughts/searchable' directory are no longer applicable.)
...
3. **Wait for all sub-agents to complete and synthesize findings:**
   ...
   - Use __agents__/research/ findings as supplementary historical context
   - Connect findings across different components
   - Include specific file paths and line numbers for reference
   - Verify all __agents__/research/ paths are correct and point to valid files
...
4. **Gather metadata for the research document:**
   ...
   - Format: `__agents__/research/YYYY-MM-DD_HH-MM-SS_topic.md`
...
5. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     **Repository**: [Repository name]
     ...
     ## Historical Context (from __agents__/research/)
     [Relevant insights from __agents__/research/ directory with references]
     - `__agents__/research/something.md` - Historical decision about X
     - `__agents__/research/notes.md` - Past exploration of Y
     Note: Paths exclude "searchable/" even if found there

     ## Related Research
     [Links to other research documents in __agents__/research/]
...
- The __agents__/research/ directory provides historical context to supplement live findings
...
- Explore all of __agents__/research/ directory
...
- (Legacy path handling rules for 'thoughts/searchable/' have been removed as the research destination is now __agents__/research/.)
