  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <div className={cn("relative flex flex-wrap gap-1", selected.length > 0 && "pr-8")}>
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
            ...
            <IconButton
              ...
              className={cn(
                'absolute ltr:right-0 rtl:left-0 text-muted-foreground hover:text-destructive hover:bg-destructive/10',
                (hideClearAllButton ||
                  disabled ||
                  selected.length < 1 ||
